...
import { Loader2, Plus, Users, Activity, Trophy, Calendar, Eye, EyeOff, Play, Pause, Edit, Trash2, AlertTriangle, Zap, Sparkles, Settings, Home } from 'lucide-react';
...
export default function AdminCompetitions() {
  ...
  const checkAdminAndLoad = async () => {
    try {
      const adminResponse = await brain.is_admin();
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      ...
      <div className="relative z-10 container mx-auto px-4 py-8">
        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            <h1 className="text-4xl font-bold text-white mb-2">🏆 Admin Competitions</h1>
      ...
      <Dialog open={showCompetitionBuilder} onOpenChange={setShowCompetitionBuilder}>
        <DialogContent className="max-w-[95vw] w-full max-h-[95vh] h-full overflow-hidden bg-slate-900 border-purple-500/30 p-0">
          <div className="h-full flex flex-col">
            ...
            <div className="flex-1 overflow-hidden">
              <CompetitionBuilder
                onClose={() => setShowCompetitionBuilder(false)}
                onSuccess={async () => {
                  setShowCompetitionBuilder(false);
                  await loadCompetitions();
                  toast.success('Competition created successfully with Competition Builder 2.0!');
                }}
              />
            </div>
          </div>
